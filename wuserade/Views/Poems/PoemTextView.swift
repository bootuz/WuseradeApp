...
struct PoemTextView: View {
    ...
    var body: some View {
        Text(text)
            .font(
                fontManager.currentSettings.fontName == "System" ? 
                    .system(size: fontManager.currentSettings.fontSize) :
                    .custom(fontManager.currentSettings.fontName, size: fontManager.currentSettings.fontSize)
            )
